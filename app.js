...
// [보안 및 에러 종결 완결판] 알림창과 팝업 시스템 함수들을 코드 최상단으로 끌어올려 순서 오류 철저히 차단
...
var langPack = {
    ...
    ja: { 
        ...
        admTitle: "👑 管理者システム", admBase: "基準日の設定", admSave: "保存", admManual: "手동予約制御", admVis: "加速表示制御", admLimits: "最小加速条件調整", admAuto: "自動スケジュール", admOpenAll: "一括オープン:", admCloseAll: "一括クローズ:", admSaveSched: "スケジュール保存", admExcel: "Excel抽出", admClose: "閉じる"
    },
    id: { 
